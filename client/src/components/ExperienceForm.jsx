...
const ExperienceForm = ({ data, onChange }) => {
  ...
  const generateDescription = async (index) =>{
    ...
    const prompt = `Enhance this job description for a resume: ${experience.description} for the 
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-3">
                <input
                  ...
                  className="px-3 py-2 text-sm rounden-lg"
                />
                ...
                <input
                  ...
                  className="px-3 py-2 text-sm rounden-lg disabled:bg-gray-100"
                />
              </div>
