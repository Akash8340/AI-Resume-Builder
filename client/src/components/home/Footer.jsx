...
const Footer = () => {
  return (
    <>
      <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-800 bg-gradient-to-r from-white via-green-300/60 to-white mt-40">
        ...
        <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
          ...
          <div className="flex items-center gap-4 mt-3">
            ...
            <a
              href="https://www.linkedin.com/in/akash-singh-63ba6a28b/"
              target="_blank"
              rel="noreferrer"
            >
              <svg
            ...
            <a
              href="https://youtube.com/@akash-ph8in?si=lRt-H9etoHH-NlmS"
              target="_blank"
              rel="noreferrer"
            >
              <svg
