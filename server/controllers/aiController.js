...
// controller for enhancing reume's professional summary
...
export const uploadResume = async (req, res) => {
    try {
        ...
        const userPrompt = `extract data from this resum: ${resumeText} 
        Provide the response in JSON format with no additional text before or after:
